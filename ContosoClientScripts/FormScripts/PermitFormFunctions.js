...
ContosoPermit.Scripts.PermitForm = {
    ...
    _handlePermitTypeSettings: function (executionContext) {
        ...
        if (permitType == null) {
            ...
            // remove the requirement and hide the "New Size" field.
            ...
            Xrm.WebApi.retrieveRecord("contoso_permittype", permitTypeID)
                .then(function (result) {
                    ...
                    //If "Require Size" field value of the Permit Type is set to Yes, make the "New Size" field visible and as required.
